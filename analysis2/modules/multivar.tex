...
\section{Funzioni a più variabili}
    ...
    \subsection{Cenni di topologia su $\mathbb{R}^{n}$}
    ...
    \subsection{Curve}
        ...
        \subsection{Campi scalari}
            ...
            \begin{theorem} [Teorema sulle condizioni sufficienti per la differenziabilità]
                Sia $f: D \subset \mathbb{R}^{n} \rightarrow \mathbb{R}$ un campo scalare e sia $\mathbf{x}_0 \in D$ un punto interno a $D$. Se tutte le derivate parziali $\partial_{x_i} f$ esistono e sono continue in $\mathbf{x}_0$ allora $f$ è differenziabile in $\mathbf{x}_0$.
            \end{theorem}
