...
\section{Numeri complessi}
    ...
    \[
        (1 \rightarrow 2) \quad z = a + ib \implies \rho = \sqrt{a^{2} + b^{2}}, \; \theta = \textnormal{atan2}\left(\frac{b}{a}\right)
    \]
    \[
    ...
    \subsection{Proprietà algebriche di \texorpdfstring{$\mathbb{C}$}{C}}
...
\section{Morfismi complessi in dominio complesso}
    ...
    \subsection{Calcolo differenziale}
        ...
        \subsubsection{Equazioni di Cauchy-Riemann}
            ...
            \begin{proof}[Dimostrazione]
                ...
                \[
                    \frac{\partial^{2} \{u, v\}}{\partial x \partial y} = \frac{\partial}{\partial y} \left(\frac{\partial \{u, v\}}{\partial x}\right) = \frac{\partial}{\partial x} \left(\frac{\partial \{u, v\}}{\partial y}\right)
                \]

                Di conseguenza si ha che
                \[
                    \frac{\partial^{2} u}{\partial x^{2}} = \frac{\partial^{2} v}{\partial y \partial x} = \frac{\partial}{\partial y} \left(\frac{\partial v}{\partial x}\right) = -\frac{\partial^{2} u}{\partial y^{2}} \implies \frac{\partial^{2} u}{\partial y^{2}} + \frac{\partial^{2} u}{\partial x^{2}} = 0 \
                \]
            \end{proof}
    ...
    \subsection{Curve ed integrali}
        ...
        \subsubsection{Integrali di linea}
            ...
            \[
                \int_{\gamma} f \: dz := \int_{a}^{b} f(\gamma) \: \gamma' \:  dt = \int_{a}^{b} \left[u(x, y) + i v(x, y)\right](x' + i y') dt =
            \]
            \[
                \int_{a}^{b} \left[u(x, y)x' - v(x, y)y'\right] \: dt + i \int_{a}^{b} \left[v(x, y)x' + u(x, y)y'\right] \: dt = \int_{\gamma} (u, -v) \cdot d\gamma + i \int_{\gamma} (v, u) \cdot d\gamma
            \]
    ...
    \subsection{Valore principale di Cauchy}
        \begin{definition}[Definizione di valore principale]
            ...
            \[
                \pv{\int_{\gamma} f(z) \: dz} = \lim_{\epsilon \rightarrow 0^{+}} \left( \int_{a}^{c - \epsilon} f(\gamma(t)) \gamma'(t) \: dt + \int_{c + \epsilon}^{b} f(\gamma(t)) \gamma'(t) \: dt\right)
            \]
        \end{definition}
