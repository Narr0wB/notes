...
\begin{document}
    ...
    \section{Operazioni sulle distribuzioni}
        ...
        Di conseguenza
        \[
            y(t) = \mathcal{H}(x(t)) = \mathcal{H}\qty(\int_{-\infty}^{\infty} x(\tau) \delta(t - \tau) \: d\tau)
        \]
        per la linearità dell'operatore $\mathcal{H}$
        \[
            \mathcal{H}\qty(\int_{-\infty}^{\infty} x(\tau) \delta(t - \tau) \: d\tau) = \int_{-\infty}^{\infty} \mathcal{H}(x(\tau) \delta(t - \tau)) \: d\tau = \int_{-\infty}^{\infty} x(\tau) \mathcal{H}(\delta(t - \tau)) \: d\tau
        \]
    ...
    \section{Trasformata di Fourier}
        ...
        \begin{enumerate}
            ...
            \[
                \forall \alpha \neq 0, \; \mathcal{F}\{x(\alpha t)\} = \int_{-\infty}^{\infty} x(\alpha t) e^{-i \omega t} \: dt = \frac{1}{\alpha} \int_{-\infty}^{\infty} x(u) e^{-i \omega \frac{u}{\alpha}} \: dt = \frac{1}{\alpha} \mathcal{F}\{x\}\qty(\frac{\omega}{\alpha})
            \]
            ...
            \[
                \mathcal{F}\{x(t) * y(t)\} = \int_{-\infty}^{\infty} \qty(\int_{-\infty}^{\infty} x(\tau) y(t - \tau) \: d\tau) e^{-i \omega t} \: dt = \int_{-\infty}^{\infty} x(\tau) \qty[\int_{-\infty}^{\infty} y(t - \tau) e^{-i \omega t} \: dt] \: d\tau = 
            \]
            \[
                \int_{-\infty}^{\infty} x(\tau) \qty[\int_{-\infty}^{\infty} y(u) e^{-i \omega (u + \tau)} \: du] \: d\tau = \int_{-\infty}^{\infty} x(\tau) e^{-i \omega \tau} \: d\tau \int_{-\infty}^{\infty} y(u) e^{-i \omega u} \: du = \mathcal{F}\{x(t)\} \mathcal{F}\{y(t)\}
            \]
        \end{enumerate}
        ...
        \begin{proof}[Dimostrazione]
            ...
            \]
            \[
                = \frac{1}{i \omega} \qty[-x(t) e^{-i \omega t} \rvert_{-\infty}^{\infty} + \int_{-\infty}^{\infty} x'(t) e^{-i \omega t} \: dt]
            \]
        ...
        \subsection{Estensione della trasformata di Fourier alle distribuzioni}
            ...
            \begin{enumerate}
                \item $\displaystyle \mathcal{F}\{u(t)\} = \PV \qty{\frac{1}{i \omega}} + \pi \delta(\omega)$
