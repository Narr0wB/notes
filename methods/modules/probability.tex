...
\section{Teoria della probabilità}
        ...
        \subsection{Assiomi della teoria della probabilità}
            ...
            \begin{axiom}[$\sigma$-additività]
                ...
                \[
                    P\left(\bigcup_{k \in A} E_{k}\right) = \sum_{k \in A} P(E_{k})
                \]
            \end{axiom}
    ...
    \section{Spazi di probabilità}
        \subsection{Spazi di probabilità finiti}
            ...
            \[
                P(E) = P\left(\bigcup_{S_{k} \in E} \{S_{k}\}\right) = \sum_{S_{k} \in E} P(\{S_{k}\})
            \]
    ...
    \section{Calcolo combinatorio}
        \begin{definition}[Disposizione]
            ...
            \[
                D_{n}(\Omega) = \left\{ (\omega_{1}, \omega_{2}, ..., \omega_{n}) \; : \; \omega_{1}, ..., \omega_{n} \in \Omega \right\}
            \]
        ...
        \begin{definition}[Disposizione semplice]
            ...
            \[
                D^{s}_{n}(\Omega) = \left\{ (\omega_{1}, \omega_{2}, ..., \omega_{n}) \; : \; \omega_{1}, ..., \omega_{n} \in \Omega, \; \forall i, j \quad i \neq j \implies \omega_{i} \neq \omega_{j} \right\}
            \]
    ...
    \section{Probabilità condizionata}
        ...
        \begin{enumerate}
            ...
            \[
                \bigcup_{i \in I} S_{i} = \bigcup_{i \in I} K_{i} \cap B = \left(\bigcup_{i \in I} K_{i}\right) \cap B
            \]
            ...
            \item Sia $\{S_{i}\}_{i \in I}$ una collezione numerabile di elementi di $\mathcal{F}_{B}$, allora
            \[
                \bigcap_{i \in I} S_{i} = \bigcap_{i \in I} K_{i} \cap B = \left(\bigcap_{i \in I} K_{i}\right) \cap B
            \]
        ...
        \subsection{Formula delle probabilità composte}
            ...
            \[
                P\left(\bigcap_{i = 1}^{n} A_{i}\right) = P(A_{1}) \cdot P(A_{2} | A_{1}) \cdot P(A_{3} | A_{1} \cap A_{2}) \cdot ... \cdot P(A_{n} | A_{1} \cap A_{2} \cap ... \cap A_{n - 1})
            \]
    ...
    \section{Variabili casuali}
        ...
        \subsection{Media, varianza e valore atteso di variabili casuali}
            ...
            In quanto:
            \[
                \mathbb{E}[Y] = \mathbb{E}\left[\frac{x - \mu_{X}}{\sigma(X)}\right] = \frac{1}{\sigma(X)} \mathbb{E}[x - \mu_{X}] = \frac{1}{\sigma(X)} (\mathbb{E}[X] - \mu_{X}) = 0
            \]

            di conseguenza
            \[
                \textnormal{var}(Y) = \mathbb{E}\left[\frac{(x - \mu_{X})^{2}}{\sigma(X)^{2}}\right] - \mathbb{E}[Y]^{2} =
        ...
        \subsection{Modelli di variabili casuali}
            \subsubsection{Variabili casuali normali}
                ...
                Arriviamo a
                \[
                    \mathbb{E}[X] = \left[- \frac{\sigma}{\sqrt{2 \pi}} e^{-\frac{(x - \mu)^{2}}{2 \sigma^{2}}}\right]^{\infty}_{-\infty} + \mu \cdot 1 = 0 + \mu = \mu
                \]
                ...
                \[
                    \mathbb{E}[(x - \mu)^{2}] = \left[(x - \mu) \cdot - \frac{\sigma}{\sqrt{2 \pi}} e^{-\frac{(x - \mu)^{2}}{2 \sigma^{2}}}\right]^{\infty}_{-\infty} + \int_{-\infty}^{\infty} \frac{\sigma}{\sqrt{2 \pi}} e^{-\frac{(x - \mu)^{2}}{2 \sigma^{2}}} =
            ...
            \subsubsection{Variabili casuali uniformi}
                ...
                \]
                \[
                    \frac{1}{b - a} \left[\frac{1}{3} x^{3}\right]^{b}_{a} - \mu_{X}^{2} =
            ...
            \subsubsection{Variabili casuali esponenziali}
                ...
                \[
                    ...
                    \left[\left. - x^{2} e^{- \lambda x} \right|_{0}^{\infty} + 2 \int_{0}^{\infty} x e^{- \lambda x} \: dx\right] - \mu_{X}^{2} =
        ...
        \subsection{Algebra su variabili casuali}
            ...
            \[
                A_{j} = \left\{ Y^{-1}(j) \; : \; j \in Y(\Omega) \right\}, \quad \bigcup_{j \in Y(\Omega)} A_{j} = \Omega
            \]
    ...
    \section{Vettori di variabili casuali}
        ...
        \subsection{Vettori aleatori discreti}
            ...
            \]
            \[
                P_{\mathbf{X}}(\mathbf{X} = \mathbf{a} \in \mathbb{R}^{n}) = P(X_{1} = a_{1}, X_{2} = a_{2}, ..., X_{n} = a_{n}) = P \left(\bigcap_{i = 1}^{n} X_{i}^{-1}(a_{i})\right)
            \]
